...
.logo{height:auto;width:190px;max-width:100%;display:block;margin:6px 0 4px;filter:drop-shadow(0 8px 18px rgba(0,0,0,.3))}
.band{padding:24px 20px 26px !important}
.band::before{right:-22%;top:-30%;width:72%;padding-top:72%;opacity:.85}
