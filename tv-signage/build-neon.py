...
def cup(color, kind):
    ...
    if kind == 'shot':
        return f'''<svg class="pa" viewBox="0 0 120 210" preserveAspectRatio="xMidYMax meet"><path fill="{color}" d="M14 122 L106 122 L97 196 Q60 207 23 196 Z"/><path class="shade" d="M74 122 L106 122 L97 196 Q80 204 66 204 Z"/><path class="sheen" d="M20 128 L30 128 L27 190 L23 190 Z"/><path d="M40 124 L36 196 M60 124 L60 200 M80 124 L84 196" fill="none" stroke="#fff" stroke-opacity=".32" stroke-width="1.5"/><path class="glass" d="M14 122 L106 122 L97 196 Q60 207 23 196 Z"/><rect class="lid" x="8" y="111" width="104" height="13" rx="6.5"/><rect x="22" y="104" width="76" height="9" rx="4.5" fill="#fff" fill-opacity=".9"/><ellipse cx="60" cy="112" rx="36" ry="2.5" fill="#fff" fill-opacity=".55"/><rect class="label" x="34" y="136" width="52" height="40" rx="8"/><image href="{LOGO}" x="37" y="142" width="46" height="28" preserveAspectRatio="xMidYMid meet"/></svg>'''
